...
const bentoCategories = [
  {
    ...
    description:
      'Building responsive and user-friendly web interfaces with modern frontend technologies, reusable components, interactive UI, and clean design.',
    stat: 'RESPONSIVE UI',
  ...
  },
  {
    ...
    description:
      'Developing backend services and REST APIs with database integration, authentication, data management, and practical full-stack application architecture.',
  ...
  },
  {
    ...
    description:
      'Building intelligent applications using document intelligence, OCR pipelines, retrieval-augmented generation, AI agents, and data-driven problem solving.',
    stat: 'AI PROJECTS',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    description:
      'Strong programming foundations supported by hands-on project development, version control, API testing, debugging, and continuous technical learning.',
    stat: 'PROJECT DRIVEN',
    colSpan: 'lg:col-span-7',
  },
];
